...
function replaceEmojis(){
	...
	chatStr = chatStr.replace(":/","<img class='emoji' src='img/normal.png' />");
	
	chatStr = chatStr.replace(";)","<img class='emoji' src='img/wink.png' />");
	
	chatStr = chatStr.replace(":D","<img class='emoji' src='img/Susmile.png' />");
	
	chatStr = chatStr.replace("D:","<img class='emoji' src='img/Rsad.png' />");
	
	chatStr = chatStr.replace("Python","********");
	
	chatStr = chatStr.replace("Javascript","********");
	
	chatStr = chatStr.replace("Fortran","********");
	
	chatStr = chatStr.replace("Pascal","********");
}
